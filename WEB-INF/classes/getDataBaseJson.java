   ...
   */
   ...
   public JSONArray createJSonArray()
   {
	   ...
	   //Connect the the database
		applicationProductManager appDBMg = new applicationProductManager();
		int i=0;
		try{
			//query the database
		   ResultSet res= appDBMg.listAllProducts();
   ...
   */ 
   public JSONObject createJSon(ResultSet res)
   {
	   ...
	   try{
			...
			json.put("id", res.getString(1));
			json.put("name", res.getString(2));
			json.put("description", res.getString(3));
			json.put("price", res.getString(4));
			json.put("department", res.getString(5));
			json.put("category", res.getString(6));
			json.put("image", res.getString(7));
